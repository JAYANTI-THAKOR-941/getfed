...
// Query for total food products
$food_product_query = mysqli_query($conn, "SELECT id FROM food_products");
if ($food_product_query) {
    $food_product_count = mysqli_num_rows($food_product_query);
} else {
    echo "Error fetching food product count: " . mysqli_error($conn);
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Admin Dashboard - GetFed Healthy Food</title>
    <style>
        .dashboard {
            width: 90%;
            margin: 50px auto;
...
<body>
    ...
    <main class="dashboard">
        ...
        <div class="cards">
            ...
            <div class="card">
                <h2><?php echo $food_product_count; ?></h2>
        ...
        <div class="links">
            ...
            <a href="report.php">Order Summary Report</a>
            <a href="food_product_dashboard.php">Manage Food Products</a>
