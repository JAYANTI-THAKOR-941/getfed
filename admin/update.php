...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['update'])) {
        ...
        if ($image) {
            ...
            $image = $product['image_url']; // Use the existing image URL
        }

        // Update the product details in the database
        $updateQuery = "UPDATE food_products SET name = '$name', description = '$description', price = '$price', category = '$category', image_url = '$image' WHERE id = $productId";
...
<head>
    ...
    <title>Update Food - Food Products Dashboard</title>
    <style>
