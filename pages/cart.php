...
if (!isset($_SESSION['cart']) || count($_SESSION['cart']) == 0) {
    ...
    <body>
        ...
        <div>
            ...
            <a href="/getfed/pages/menu.php" class="shopping-button">Go to Shopping</a>
        </div>
    </body>
    </html>
    <?php
...
if ($_POST['action'] == 'increase') {
    // Check if the current quantity is less than 15
    if ($_SESSION['cart'][$productId]['quantity'] < 15) {
        $_SESSION['cart'][$productId]['quantity']++;
    } else {
        echo "<script>alert('You cannot add more than 15 of this product.');</script>";
    }
            ...
            <tbody>
                ...
                ?>
                            <tr>
                                ...
                                <td><img src="../assets/images/<?php echo $product['image_url']; ?>" alt="<?php echo $product['name']; ?>" width="100" height="100"></td>
